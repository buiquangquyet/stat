...
class Paypal extends Component
{
   ...
   */
  public $apiUsername = 'paymentsg-facilitator_api1.weshop.asia';
   ...
   */
  public $apiPassword = 'ZT8QE6MJQ7H9TW9V';

  /**
   * # API_Signature:The Signature associated with the API user. which is generated by paypal.
   */
  public $apiSignature = 'AF1KZ7k5nNzKXKND2K5fOrBMlNf0AFOB07LB-JZNG39JG.BZy4jnXS5L';
  public $apiLive = false;

  /**
   * # The url (relative to base url) to return the customer after a successful payment
   */
  public $returnUrl = 'http://weshop.sg/sg/paypal/confirm/';

  /**
   * # The url (relative to base url) to return the customer if he/she cancels the payment
   */
  public $cancelUrl = 'http://weshop.sg/paypal/cancel/';
  ...
  public function SetExpressCheckout($paymentInfo = array())
  {
    ...
    if ($paymentInfo['Order']['quantity']) {
      $quantity = intval(urlencode($paymentInfo['Order']['quantity']));
    } else {
    ...
    $itemName = urlencode($paymentInfo['Order']['item_name']);
    $itemId = urlencode($paymentInfo['Order']['item_id']);
...
//        var_dump($paymentInfo);die;
    ...
    $address1 = urlencode($paymentInfo['SHIPTOSTREET']);
    $country = urlencode($paymentInfo['SHIPTOCOUNTRYCODE']);
    $city = urlencode($paymentInfo['SHIPTOCOUNTRYNAME']);
//        $state = urlencode($paymentInfo['SHIPTOSTATE']);
    $zip = urlencode($paymentInfo['SHIPTOZIP']);

    $itemName = urlencode($paymentInfo['L_NAME0']);
    $itemId = urlencode($paymentInfo['L_NUMBER0']);
    $desc = $paymentInfo['DESC'];
    $amount = urlencode($paymentInfo['AMT']);
    $quantity = $paymentInfo['L_QTY0'];


    $nvpstr = '&TOKEN=' . urlencode($paymentInfo['TOKEN']) .
